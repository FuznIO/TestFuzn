...
public class HttpRequest
{
    ...
    private LoggingVerbosity _loggingVerbosity = HttpTesting.LoggingVerbosity.Full;
    ...
    public string UserAgent { get; set; } = "TestFusionHttpTesting/1.0";
    ...
    public async Task<HttpResponse> Send()
    {
        ...
        try
        {
            var httpClientFactory = GlobalState.Configuration.CustomHttpClientFactory ?? _context.Internals.Plugins.GetState<IHttpClientFactory>(typeof(HttpTestingPlugin));
        ...
        {
            if (_loggingVerbosity > TestFusion.HttpTesting.LoggingVerbosity.None)
        ...
        finally
        {
            ...
            {
                if (_loggingVerbosity == TestFusion.HttpTesting.LoggingVerbosity.Full)
                {
