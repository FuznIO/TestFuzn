...
internal class ReportManager
{
    ...
    public async Task WriteLoadReports(SharedExecutionState sharedExecutionState)
    {
        ...
        foreach (var scenario in sharedExecutionState.Scenarios)
        {
            ...
            data.Feature.Name = sharedExecutionState.IFeatureTestClassInstance.Group.Name;
            data.Feature.Id = sharedExecutionState.IFeatureTestClassInstance.Group.Id;
            data.Feature.Metadata = sharedExecutionState.IFeatureTestClassInstance.Group.Metadata;
            data.TestsOutputDirectory = GlobalState.TestsOutputDirectory;
