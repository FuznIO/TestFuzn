...
[FeatureTest]
public class AlternativeSyntax : BaseFeatureTest
{
    ...
    public async Task Verify()
    {
        await Scenario("Verify that get products works")
            ...
            .Step("Cleanup products", async (context) =>
            {
                var response = await context.CreateHttpRequest("https://localhost:44316/api/Products").Delete();
            })
            .Run();
    }
}