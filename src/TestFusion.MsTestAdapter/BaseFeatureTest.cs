...
public abstract class BaseFeatureTest : IFeatureTest
{
    ...
    {
        var scenario = new ScenarioBuilder<StepContext>(new MsTestProvider(TestContext), this, scenarioName);
        return scenario;
    }
    ...
    {
        var scenario = new ScenarioBuilder<TStepContext>(new MsTestProvider(TestContext), this, scenarioName);
        return scenario;
    }
