...
internal class FeatureHtmlReportWriter : IFeatureReport
{
    ...
    private string GenerateHtmlReport(FeatureReportData featureReportData)
    {
        ...
        builder.AppendLine($"<p>Test Run Start Time: <strong>{featureReportData.TestRunStartTime.ToLocalTime}</strong></p>");
        builder.AppendLine($"<p>Test Run End Time: <strong>{featureReportData.TestRunEndTime.ToLocalTime}</strong></p>");
        builder.AppendLine($"<p>Test Run Duration: <strong>{featureReportData.TestRunDuration.ToTestFusionFormattedDuration()}</strong></p>");
